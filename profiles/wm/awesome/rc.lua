...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.mylayout_popup:connect_signal('button::release', function()
    s.mylayout_popup.visible = false
  end)
...
local globalkeys = gears.table.join(
  ...
  end, { description = 'print menu', group = 'awesome' }),
  -- Layout manipulation
  ...
  awful.key({ modkey, 'Shift' }, 'd', function()
    awful.spawn('rofi -show run -sidebar-mode')
