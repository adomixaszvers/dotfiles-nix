  ...
  internal = rec {
    ...
    crates = {
      ...
      "penrose" = rec {
        ...
        src = pkgs.fetchgit {
          url = "https://github.com/sminez/penrose";
          rev = "5efd2bcfa3831d02b87056583e66eac8bb92cb9d";
          sha256 = "132d7w1y0yismhb2z2sch7lvnlrjrbqvq1b4frp16bak9bcjjk9a";
        };
      ...
      "tracing" = rec {
        ...
        resolvedDefaultFeatures =
          [ "attributes" "default" "log" "std" "tracing-attributes" ];
      };
