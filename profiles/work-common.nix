{ pkgs, unstable, lib, myPkgs, config, inputs, ... }: {
    ...
    autorandr = {
      ...
      profiles = let
        fingerprints = rec {
          ...
          DP-2-3 =
            "";
          DP-2-2 =
            "";
          DP-3-2 = DP-2-2;
          DP-3-3 = DP-2-3;
        };
      in {
  ...
  services = {
    ...
    polybar.config = {
      ...
      "bar/top" = {
        modules-right =
          "battery disk memory cpu temperature volume keyboard date time tray";
      };
      "module/battery" = {
