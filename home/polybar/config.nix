...
font-0 = "Noto Sans Nerd Font:size=10;0"
font-1 = "DejaVuSansMono Nerd Font:size=10;0"
font-2 = "Noto Sans Nerd Font:size=10;0"
...
type = custom/script
exec = ${scripts.check-all-updates}
interval = 1000
...
type = custom/script
exec = ${scripts.compton}
click-left = ${scripts.compton-toggle}
interval = 5
format-foreground = ${colors.foreground}
format-background = ${colors.background}
