...
, libtool, openssl, systemd, pam, fuse, libjpeg, libopus, nasm, xorg, srcOnly }:

let
  xrdpSrc = srcOnly { inherit (xrdp) src patches pname version; };
  xorgxrdp = stdenv.mkDerivation rec {
    ...
    configureFlags = [ "XRDP_CFLAGS=-I${xrdpSrc}/common" ];
