{ config, inputs, ... }:
{
  ...
  services.xrdp = {
    ...
    extraConfDirCommands =
      ...
      # bash
      ''
        cp ${builtins.path { path = "${self}/pkgs/custom-xrdp/km-00010427.ini"; }} $out/km-00010427.ini
        cp ${builtins.path { path = "${self}/pkgs/custom-xrdp/xrdp_keyboard.ini"; }} $out/xrdp_keyboard.ini
