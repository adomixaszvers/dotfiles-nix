{ stdenv, lib, pcsclite, libarchive, qt5, fetchurl, autoPatchelfHook, openssl,
}:
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url =
      "https://github.com/dokobit/browser-plugin/raw/master/Linux/64Bit/dokobit-plugin-en_${finalAttrs.version}.deb";
    sha256 = "1xwd2g4ix0ym7g6rfcynnfg8dv4pjy73g35985hxmxc0gwzzsvc1";
  };
  buildInputs = [ pcsclite qt5.qtbase openssl ];
